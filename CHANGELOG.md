...
### Fixed
- Web: add a persistent Dashboard analysis-records panel for the latest result per symbol and hide low-level OHLCV provider verification notices from the beginner-facing analysis view.
